          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
            ...
            {mobileMenuOpen && (
              <div className="mt-4 space-y-1 border-t border-zinc-200 pt-4">
                <SideLink to="/home" label="Home" onClick={() => setMobileMenuOpen(false)} />
                ...
                <button
                  ...
                  className="w-full rounded-xl border border-zinc-200 px-3 py-2 text-left text-sm font-semibold text-zinc-700 hover:bg-zinc-50"
                >
                  Refresh totals
                </button>
