...
app.post("/api/auth/login", async (c) => {
  ...
  await c.env.DB.prepare(
    `INSERT INTO sessions (id, user_id, token_hash, expires_at, created_at)
     VALUES (?, ?, ?, ?, ?)`
  ).bind(uid(), user.id, tokenHash, expiresAt, (/* @__PURE__ */ new Date()).toISOString()).run();
...
// .wrangler/tmp/bundle-JI7FiD/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JI7FiD/middleware-loader.entry.ts
